...
Note: It should be possible to link to the test results file generated by NUnit console (see Reporting section). A bug has been raised in the Pickles github project as there appears to be an error with this (https://github.com/picklesdoc/pickles/issues/223)
